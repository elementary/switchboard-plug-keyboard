...
public class Keyboard.LayoutPage.Page : Gtk.Grid {
    private const string MULTITASKING_VIEW_COMMAND = "dbus-send --session --dest=io.elementary.gala --print-reply /io/elementary/gala .pantheon.gala.PerformAction int32:1";
