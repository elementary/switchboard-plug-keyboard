namespace Pantheon.Keyboard.Options {
	...
	class OptionHandler : GLib.Object {
		...
		private void generate_items () {
                    ...
                    /* generated from GnomeDesktop.XkbInfo. should be generated on runtime in the future */
                    var item = new Item (_("Key to choose 5th level"), "lv5", true);
                    ...
                    item = new Item (_("Adding Esperanto supersigned letters"), "esperanto", false);
                    item.set (_("To the corresponding key in a Colemak layout"), "esperanto:colemak");
                    item.set (_("To the corresponding key in a Dvorak layout"), "esperanto:dvorak");
                    item.set (_("To the corresponding key in a Qwerty layout"), "esperanto:qwerty");
                    items.append (item);
                    ...
                    item.set (_("Right Alt, Shift+Right Alt key is Compose"), "lv3:ralt_switch_multikey");
                    ...
                    item = new Item (_("Switching to another layout"), "grp", true);
                    ...
                    item.set (_("LeftCtrl+LeftWin (to first layout), RightCtrl+Menu (to second layout)"), "grp:lctrl_lwin_rctrl_menu");
                    ...
                    item.set (_("Ctrl is mapped to Win keys (and the usual Ctrl keys)"), "altwin:ctrl_win");
                    ...
                    item.set (_("Ctrl is mapped to Alt keys, Alt is mapped to Win keys"), "altwin:ctrl_alt_win");
                    ...
                    item.set (_("Shift + NumLock toggles PointerKeys"), "keypad:pointerkeys");
                    ...
                    item.set (_("Non-breakable space character at third level, nothing at fourth level"), "nbsp:level3s");
                    ...
                    item = new Item (_("Adding currency signs to certain keys"), "currencysign", true);
                    ...
                    item = new Item (_("Position of Compose key"), "Compose key", true);
                    item.set (_("Scroll Lock"), "compose:sclk");
                    item.set (_("3rd level of Menu"), "compose:menu-altgr");
                    item.set (_("<Less/Greater>"), "compose:102");
                    item.set (_("Pause"), "compose:paus");
                    item.set (_("3rd level of <Less/Greater>"), "compose:102-altgr");
                    item.set (_("3rd level of Left Ctrl"), "compose:lctrl-altgr");
                    item.set (_("3rd level of Right Ctrl"), "compose:rctrl-altgr");
                    item.set (_("Right Alt"), "compose:ralt");
                    item.set (_("3rd level of Caps Lock"), "compose:caps-altgr");
                    item.set (_("3rd level of Right Win"), "compose:rwin-altgr");
                    item.set (_("Left Win"), "compose:lwin");
                    item.set (_("3rd level of Left Win"), "compose:lwin-altgr");
                    ...
                    item.set (_("Semicolon on third level"), "kpdl:semi");
                    item.set (_("Four-level key with dot, Latin-9 only"), "kpdl:dotoss_latin9");
                    ...
                    item.set (_("Caps Lock toggles ShiftLock (affects all keys)"), "caps:shiftlock");
                    ...
                    item.set (_("Make Caps Lock an additional Ctrl"), "caps:ctrl_modifier");
                    ...
                    item.set (_("Ctrl + Alt + Backspace"), "terminate:ctrl_alt_bksp");
                    items.append (item);

                    item = new Item (_("Maintain key compatibility with old Solaris keycodes"), "solaris", true);
                    item.set (_("Sun Key compatibility"), "solaris:sun_compat");
                    items.append (item);

                    item = new Item (_("Layout of numeric keypad"), "keypad", false);
